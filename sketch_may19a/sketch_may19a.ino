...
#define DEBUG true
SoftwareSerial esp8266(10,11); // This will make the Arduino pin 2 as the RX pin and Arduino pin 3 as the TX. Software UART
...
void setup() 
{
  ...
  pinMode(13,OUTPUT);   // Setting the pin 11 as the output pin.
  digitalWrite(13,LOW); // Making it low.
